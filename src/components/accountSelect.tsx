        ...
        <SelectTrigger className={className}>
          <div className="flex items-center justify-between w-full">
            <div className="flex gap-2">
              <span className="caption1 font-medium text-[#3B8668]">
                ...
                >
                  <div className="flex flex-col items-start">
                    ...
                    {option.accountNumber && (
                      <span className="caption2 text-muted-foreground">{option.accountNumber}</span>
                    )}
                    {option.balance && (
                      <span className="caption2 text-muted-foreground">{option.balance}</span>
                    )}
                  </div>
                </SelectItem>
              ))}
