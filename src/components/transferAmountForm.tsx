...
const TransferAmountForm = () => {
    ...
    const onSubmit = (data: {
        ...
        dispatch(transferSlice.actions.addAmount({
            ...
            <FormGroup className="w-[50%] self-center">
                <div className="flex flex-col flex-1 gap-2">
                    <div className="flex items-center justify-center gap-1">
                        {fromAccountData && (
                            <p className="currency font-black">{fromAccountData.currency}</p>
                        )}
                        <CurrencyInput
                            className={cn(
                    ...
                    {formState.errors.amount && (
                        <p className="caption2 text-destructive text-center">{formState.errors.amount.message?.toString()}</p>
                    )}
                </div>
            </FormGroup>
